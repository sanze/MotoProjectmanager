...
public class CommonServiceImpl implements CommonService {
	 ...
	 * @param request
	 */
	public <T> T uploadFile(UploadFile uploadFile,boolean needResize,Double width,Double height) {
		return commonDao.uploadFile(uploadFile,needResize,width,height);
	}
